...
const TodoItem = ({ todoName }) => {
  return (
    <>
      <Box w={"full"} display={"flex"} justifyContent={"space-between"} alignItems={"center"} borderBottom={"1px solid #00000026"} pb={2}>
        ...
        <Stack direction={"column"}>
            ...
            <Box display={"flex"}>
              <Box display={"flex"} gap={2} justifyContent={"center"} alignItems={"center"} width={28} textAlign={"center"} borderRight={"1px solid #00000026"}>
                ...
                <Text fontWeight={500} fontSize={14}>22-04-24</Text>
              </Box>
              <Box display={"flex"} gap={2} justifyContent={"center"} alignItems={"center"} width={28} textAlign={"center"} borderRight={"1px solid #00000026"}>
